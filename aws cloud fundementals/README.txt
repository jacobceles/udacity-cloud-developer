...
- **Static Hosting Setting:**
  ...
  ![Static Hosting Setting](screenshots/static_hosting_setting.png)
...
- **Using CloudFront domain name:**
  ...
  ![CloudFront Domain Name](screenshots/CloudFront_domain_name.png)

- **Using Website endpoint:**

  ![Website Endpoint](screenshots/Website_endpoint.png)

- **Using S3 object URL:**

  ![S3 Object URL](screenshots/S3_object_URL.png)
